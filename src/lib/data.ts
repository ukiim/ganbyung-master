...
export const INTERFACES = [
  { icon: "bank" as const, title: "은행 즉시이체", desc: "간병비 결제·간병료 정산" },
  { icon: "creditCard" as const, title: "신용카드 결제승인", desc: "카드 결제·취소·환급" },
  { icon: "hospital" as const, title: "건강보험심사평가원", desc: "병원 검색·조회" },
  { icon: "shieldCheck" as const, title: "화재보험사", desc: "간병인 배상책임보험" },
  { icon: "phone" as const, title: "휴대폰 본인인증", desc: "회원 가입·신원확인" },
  { icon: "kakao" as const, title: "카카오 알림톡", desc: "간병비 협의·알림" },
];
