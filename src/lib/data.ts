...
export const CAREGIVERS: Caregiver[] = [
  ...
  },
  {
    ...
    careerYears: 14,
    region: "서울 노원",
    specialties: ["재활 보조", "거동 불편"],
    certs: ["요양보호사 1급", "간병사"],
    dailyRate: 132000,
    insured: true,
    tag: "추천",
    intro: "재활 환자 보행 훈련 보조 경험이 많습니다. 차분하게 환자를 이끕니다.",
    color: "#0d9488",
  },
  {
    id: "cg-1377",
    ...
    careerYears: 9,
    region: "서울 마포",
    specialties: ["수술 후 회복", "욕창 관리"],
    certs: ["요양보호사 1급"],
    dailyRate: 128000,
    insured: true,
    intro: "수술 직후 상처·욕창 관리에 꼼꼼합니다. 보호자 소통을 중요하게 생각합니다.",
    color: "#0e9e6e",
  },
  {
    id: "cg-1401",
    ...
    careerYears: 6,
    region: "서울 영등포",
    specialties: ["남성 환자", "재활 보조"],
    certs: ["요양보호사 1급", "물리치료 보조"],
    dailyRate: 138000,
    insured: true,
    tag: "지명",
    intro: "남성 중증 환자 이동·재활 보조에 강점이 있습니다. 책임감이 강합니다.",
    color: "#2563eb",
  },
  {
    id: "cg-1433",
    ...
    careerYears: 22,
    region: "서울 동작",
    specialties: ["치매", "노인성 질환"],
    certs: ["요양보호사 1급", "간병사", "치매전문교육 이수"],
    dailyRate: 136000,
    insured: true,
    tag: "추천",
    intro: "22년 경력의 치매 케어 전문가. 어르신 정서 안정과 가족 상담에 능숙합니다.",
    color: "#7c3aed",
  },
  {
    id: "cg-1466",
    ...
    careerYears: 3,
    region: "서울 성북",
    specialties: ["산모·신생아", "수술 후 회복"],
    certs: ["요양보호사 1급", "산후관리사"],
    dailyRate: 124000,
    insured: true,
    tag: "신규",
    intro: "성실하고 위생 관리가 철저합니다. 신규 등록 후 재요청률이 높습니다.",
    color: "#d97706",
  },
];
...
export const HOSPITALS: Hospital[] = [
  ...
  { name: "세브란스병원", dept: "재활의학과·신경외과", region: "서울 서대문구", beds: 2400 },
  { name: "서울성모병원", dept: "정형외과", region: "서울 서초구", beds: 1300 },
  { name: "고려대학교안암병원", dept: "신경외과", region: "서울 성북구", beds: 1000 },
  { name: "한양대학교병원", dept: "재활의학과", region: "서울 성동구", beds: 850 },
  { name: "중앙대학교병원", dept: "정형외과", region: "서울 동작구", beds: 800 },
  { name: "이대목동병원", dept: "신경과", region: "서울 양천구", beds: 800 },
  { name: "노원을지대학교병원", dept: "정형외과", region: "서울 노원구", beds: 700 },
  { name: "강북삼성병원", dept: "재활의학과", region: "서울 종로구", beds: 700 },
  { name: "인제대학교상계백병원", dept: "신경외과", region: "서울 노원구", beds: 600 },
  { name: "순천향대학교서울병원", dept: "재활의학과", region: "서울 용산구", beds: 700 },
];
